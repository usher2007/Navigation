...
// AudioCaptureDlg.cpp : implementation file
//

#include "stdafx.h"
#include "AudioCapture.h"
#include "AudioCaptureDlg.h"
...
CAudioCaptureDlg::CAudioCaptureDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CAudioCaptureDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CAudioCaptureDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CAudioCaptureDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CAudioCaptureDlg message handlers

BOOL CAudioCaptureDlg::OnInitDialog()
{
...
void CAudioCaptureDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CAudioCaptureDlg::OnQueryDragIcon()
{
...
void CAudioCaptureDlg::OnBnClickedOk()
{
	// TODO: Add your control notification handler code here
	if(m_bRecord)
	{
		pRecordGraph->Stop();
		this->GetDlgItem(IDOK)->SetWindowTextW(L"Record");
	}
	else
	{
